...
![Monokai Dark Too Vibrant](./Images/dark-too-vibrant.png)
...
Voici ton `README.md` mis à jour.

J'en ai profité pour corriger deux petits détails :

1. J'ai aligné la légende de la première image sur le nouveau nom (*Monokai Dark Too Vibrant*).
2. J'ai corrigé une petite parenthèse en trop à l'étape 5 de l'installation et mis la vraie commande CLI officielle de VS Code (`code --install-extension`).
...
3. Click **Install**
4. Click **Reload** (if required)
5. Go to `Preferences: Color Theme` and select your favorite variant!
